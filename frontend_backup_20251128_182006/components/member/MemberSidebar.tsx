...
const menuItems: MenuItem[] = [
    { label: 'Home', icon: <Home size={18} />, href: '/member' },
    { label: 'Node', icon: <Edit3 size={18} />, href: '/member/node' },
    { label: 'Track', icon: <FileCheck size={18} />, href: '/member/track' },
    { label: 'Chat', icon: <MessageCircle size={18} />, href: '/member/chat' },
    { label: 'Groups', icon: <Users size={18} />, href: '/member/groups' },
];
