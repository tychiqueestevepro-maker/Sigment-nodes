...
export default function BoardPanelMembersPage() {
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto flex flex-col">
            ...
            <div className="mb-8 flex items-start justify-between">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="bg-green-50 text-green-700 px-2 py-0.5 rounded text-xs font-bold uppercase tracking-wider flex items-center gap-1">
                ...
                <button
                    onClick={() => router.push(`/${orgSlug}/board`)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div
                    onClick={() => router.push(`/${orgSlug}/board/panel/members/invitations`)}
            ...
            {/* Invite Box */}
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-6 flex items-center justify-between mb-8">
                <div>
