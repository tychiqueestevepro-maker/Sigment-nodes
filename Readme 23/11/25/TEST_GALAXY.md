# 🧪 Galaxy Dashboard - Quick Test Guide
...
**What you should see**:
- 🌌 **Galaxy Chart**: Scatter plot with colored bubbles
- 📊 **Filter Bar**: Impact slider + Pillar dropdown
- 📋 **Priority List**: Top 10 clusters on the right
...
2. Chart updates → Only clusters with score ≥ 5 remain
...
# Should see: ✅ Retrieved N clusters for Galaxy view
```
...
```
┌──────────────────────────────────────────────────┐
│  🌌 Strategic Galaxy        [12 Active Clusters] │
├──────────────────────────────────────────────────┤
│  Filters:  [Impact: ══●════] [Pillar: All ▼]    │
├────────────────────────────────┬─────────────────┤
│  Impact × Volume Matrix        │  Top Priorities │
│                                │                 │
│         •  (ESG)               │ 1. Parking...   │
│      •     • (Ops)             │ 2. Coffee...    │
│   •  (Tech)                    │ 3. Deploy...    │
